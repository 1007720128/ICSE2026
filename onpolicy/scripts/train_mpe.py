...
def main(args):
    ...
    all_args.algorithm_name = "rmappo"
    all_args.share_policy = True
    all_args.scenario_name = "graph"
    all_args.project_name = "informarl"
    all_args.env_name = "GraphMPE"
    all_args.algorithm_name = "rmappo"
    all_args.experiment_name = "informarl"
    all_args.scenario_name = "navigation_graph"
    all_args.num_agents = 3
    all_args.user_name = "marl"
    all_args.use_cent_obs = False
