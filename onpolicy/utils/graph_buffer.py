...
class GraphReplayBuffer(object):
    ...
    def __init__(self, args: argparse.Namespace, num_agents: int, obs_space: gym.Space, cent_obs_space: gym.Space,
                 node_obs_space: gym.Space, agent_id_space: gym.Space, share_agent_id_space: gym.Space,
                 adj_space: gym.Space, act_space: gym.Space, num_svc=5):
        ...
        self.svc_adj = np.zeros(
            (self.episode_length + 1, self.n_rollout_threads, num_agents, num_svc, num_svc),
            dtype=np.float32,
        )
    ...
    def recurrent_generator(
        ...
        for indices in sampler:
            ...
            yield share_obs_batch, obs_batch, node_obs_batch, adj_batch, svc_adj_batch, agent_id_batch, share_agent_id_batch, rnn_states_batch, rnn_states_critic_batch, actions_batch, value_preds_batch, return_batch, masks_batch, active_masks_batch, old_action_log_probs_batch, adv_targ, available_actions_batch
